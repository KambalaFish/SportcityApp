...
import sportcityApp.services.impl.api.CrudServiceApi;
...
public abstract class AbstractCrudServiceImpl<T extends Entity> implements Service<T> {
    ...
    protected AbstractCrudServiceImpl(Class<? extends CrudServiceApi> serviceApiClass, Class<T> entityClass, String baseUrl, String urlRoot){
